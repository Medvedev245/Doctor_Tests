  ...
  return (
    <>
      ...
      <SectionPic>
        ...
        {/* <br />
        <p style={{ textIndent: '15px', color: 'rgb(255 0 0)' }}>
          В разделе "Take a tests" Вы можете пройти тесты по выбранной теме.
          Базы: Legislativa_Báze_2023, Medicine_2023, Živný, Klener. Выбрать
          нужное количество тестов. Посмотреть свой результат и правильные
          ответы.
        </p>
        <br />
        <p style={{ textIndent: '15px', color: 'rgb(255 0 127)' }}>
          В разделе "All tests" Можно выбрать базу для изучения и анализа. В
          некоторых тестах есть писание. также тест можно добавить к себе в базу
          - "My Base".
        </p>
        <br />
        <p style={{ textIndent: '15px', color: 'rgb(127 0 255)' }}>
          В разделе "My Base" Вы можете создать свою собственную выборку тестов
          из всех существующих. Добавлять или удалять тесты. Так же можно пройти
          тестирование по своей базе.
        </p>

        <br />
        <p style={{ textIndent: '15px', color: 'rgb(255 113 0)' }}>
